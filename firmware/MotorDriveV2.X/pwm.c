...
void init_PWM1()
{
    ...
    PWM1CON2bits.IUE = 0;       // Mise à jour des registres de rapport cycliques synchronisé avec la base de temps PWM
    
    //---Output Override Control --inutilisé pour l'instant
    PWM1CON2bits.OSYNC = 1;     // Synchronisé sur base de temps PWM
    
    //----Dead time----- juste copié collé du code existant pour l'instant
