...
#define muxSEL1         LATC8
#define muxSEL2         LATC7
#define muxSEL3         LATC6

void init_pic(void);

/*
typedef struct muxSEL_TRIS {
  uint16_t muxSEL1_TRIS:1;
  uint16_t muxSEL2_TRIS:1;
  uint16_t muxSEL3_TRIS:1;
} muxSEL_TRIS;

typedef struct muxSEL {
  uint16_t muxSEL1:1;
  uint16_t muxSEL2:1;
  uint16_t muxSEL3:1;
} muxSEL;
