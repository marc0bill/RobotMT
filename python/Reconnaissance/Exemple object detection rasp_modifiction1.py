# -*- coding: utf-8 -*-
"""
Created on Sat May  4 18:44:37 2019
...
frame_rate_calc = 1					#Initialise le calcul de la framerate
...
if camera_type == 'picamera':
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):   #capture la caméra en continue 
        ...
        t1 = cv2.getTickCount() #retourne le nb de coup d'horloge entre l'appel de cette fonction et le début de la boucle for
